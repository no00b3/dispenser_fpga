...
#set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { w }]; #IO_L7N_T1_D10_14 Sch=sw[5]
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { w }]; #IO_L17N_T2_A13_D29_14 Sch=sw[6]
#set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { w }]; #IO_L5N_T0_D07_14 Sch=sw[7]
#set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { w }]; #IO_L24N_T3_34 Sch=sw[8]
#set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { w }]; #IO_25_34 Sch=sw[9]
...
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {LED[5]}]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {LED[6]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {LED[7]}]
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { an1 }]; #IO_L22P_T3_A05_D21_14 Sch=led[10]
#set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { an2 }]; #IO_L15N_T2_DQS_DOUT_CSO_B_14 Sch=led[11]
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { an3}]; #IO_L16P_T2_CSI_B_14 Sch=led[12]
#set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { y }]; #IO_L22N_T3_A04_D20_14 Sch=led[13]
...
set_property -dict {PACKAGE_PIN J17 IOSTANDARD LVCMOS33} [get_ports an3]
set_property -dict {PACKAGE_PIN J18 IOSTANDARD LVCMOS33} [get_ports an0]
set_property -dict {PACKAGE_PIN T9 IOSTANDARD LVCMOS33} [get_ports an1]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33} [get_ports an2]
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { anode}]; #IO_L8N_T1_D12_14 Sch=an[4]
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { anode}]; #IO_L14P_T2_SRCC_14 Sch=an[5]
#set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { anode}]; #IO_L23P_T3_35 Sch=an[6]
#set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { anode}]; #IO_L23N_T3_A02_D18_14 Sch=an[7]
...
set_property IOSTANDARD LVCMOS33 [get_ports {digit3[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digit3[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digit3[4]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports {digit4[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digit4[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {digit4[4]}]
